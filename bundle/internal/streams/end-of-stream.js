//Patch
//BOCK
var primordials = require("../per_context/primordials.js");var process = require("../process.js");// Ported from https://github.com/mafintosh/end-of-stream with
...
function eos(stream, options, callback) {
  ...
  if (options.signal && !closed) {
    ...
    if (options.signal.aborted) {
      ...
      addAbortListener ??= require('../events/abort_listener').addAbortListener;
