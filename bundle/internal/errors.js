//Patch
//BOCK
var primordials = require("./per_context/primordials.js");var process = require("./process.js");/* eslint node-core/documented-errors: "error" */
...
function lazyInternalUtilInspect() {
  internalUtilInspect ??= require('./util/inspect');
...
function isErrorStackTraceLimitWritable() {
  ...
  if (require('./v8/startup_snapshot').namespace.isBuildingSnapshot()) {
    return false;
  }
